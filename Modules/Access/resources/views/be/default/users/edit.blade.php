...
<div class="tw-card">
    ...
    <form method="POST" action="{{ route('admin.v1.access.user.update', $user->id) }}?_method=PUT" enctype="multipart/form-data">
        @csrf
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="file" id="picture" name="picture" class="form-control @error('picture') is-invalid @enderror"
                       accept="image/*" onchange="previewPicture(this)">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center gap-2">
                    <input type="checkbox" id="blocked" name="blocked" value="1" class="form-check-input"
                           {{ old('blocked', $user->blocked) ? 'checked' : '' }}
                ...
                <div id="blocked-reason-wrap" style="{{ old('blocked', $user->blocked) ? '' : 'display:none' }}" class="mt-2">
                    ...
                    <input type="text" id="blocked_reason" name="blocked_reason"
                           ...
                           value="{{ old('blocked_reason', $user->blocked_reason) }}" placeholder="Reason for blocking...">
